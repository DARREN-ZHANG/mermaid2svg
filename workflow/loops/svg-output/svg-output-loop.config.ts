...
export const SVG_OUTPUT_LOOP_PHASES: PhaseDefinition[] = [
  {
    id: "preflight",
    kind: "shell",
    description: "Verify render-loop artifacts and canonical docs exist before SVG output compatibility work starts.",
    maxAttempts: 1,
  ...
  },
  {
    ...
    kind: "opencode",
    description: "Plan the SVG output compatibility contract without changing UI, theme, size, i18n, or deployment code.",
    maxAttempts: 2,
  ...
  },
  {
    ...
    kind: "opencode",
    description: "Implement general SVG output normalization and a stable result contract around the renderer output.",
    maxAttempts: 2,
  ...
  },
  {
    ...
    kind: "opencode",
    description: "Add SVG output compatibility tests for structure, stability, unsafe content removal, and error result shape.",
    maxAttempts: 2,
  ...
  },
  {
    id: "validation",
    kind: "opencode",
    description: "Run render and SVG output tests, then record machine-readable compatibility results.",
    maxAttempts: 2,
  ...
  },
  {
    id: "final-report",
    kind: "opencode",
    description: "Write the final SVG output loop report from deterministic artifacts and verification output.",
    maxAttempts: 2,
