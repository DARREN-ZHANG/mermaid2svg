...
const size_data =
  ...
  '    version: "' + bm_report.source.version + '",\n' +
  '    rawBytes: ' + bm_report.rawBytes + ',\n' +
  '    gzipBytes: ' + bm_report.gzipBytes + ',\n' +
  '  },\n' +
  '  ours: {\n' +
  '    label: "mermaid2svg",\n' +
  '    rawBytes: ' + ours_report.rawBytes + ',\n' +
  '    gzipBytes: ' + ours_report.gzipBytes + ',\n' +
  '  },\n' +
  '};\n'
...
console.log('  beautiful-mermaid ' + bm_report.source.version + ' (' + bm_report.source.gitDescribe + ')')
